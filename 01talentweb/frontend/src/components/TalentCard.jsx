    ...
    <div className="bg-[--color-primary-50] rounded-3xl shadow-md px-6 py-8 text-center max-w-sm mx-auto">
      ...
      <div className="flex justify-center gap-4">
        <Link
          ...
          className="bg-[--color-primary-500] text-white text-body-l font-medium py-2 px-6 rounded-lg hover:bg-[--color-primary-400] transition"
        >
          Portfolio
        </Link>
        <button
          className="text-[--color-primary-500] border border-[--color-primary-500] text-body-l font-medium py-2 px-6 rounded-lg hover:bg-[--color-primary-100] transition"
        >
          Hire
        </button>
      </div>
