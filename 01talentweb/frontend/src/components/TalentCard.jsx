    ...
    <div className="bg-[--color-primary-50] shadow-md px-12 py-16 text-center mx-auto w-[488px] h-[750px] rounded-[60.8px] transition-all hover:shadow-lg hover:-translate-y-1 flex flex-col items-center">
      ...
      <div className="flex justify-center gap-6">
        <Link
          ...
          className="bg-[--color-primary-500] text-white text-body-l font-medium py-[10px] w-[174px] h-[48px] flex items-center justify-center rounded-lg hover:bg-[--color-primary-400] transition"
        >
          Portfolio
        </Link>
        <button
          className="text-[--color-primary-500] border border-[--color-primary-500] text-body-l font-medium py-[10px] w-[174px] h-[48px] flex items-center justify-center rounded-lg hover:bg-[--color-primary-100] transition"
        >
          Hire
        </button>
      </div>
