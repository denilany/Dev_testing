...
export default function WhoWeAre() {
  return (
    <section className="bg-[#F7F9FC] px-4 py-12 md:py-20 lg:py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-4 xl:ml-18 text-gray-700 text-sm md:text-base  xl:text-[28px] font-normal xl:leading-[120%]">
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
          ...
          <div className="relative w-full ">
            ...
            <img
              ...
              alt="Team"
              className="w-full rounded-md shadow-lg object-cover xl:ml-18
              "
            />
            ...
            <img
              ...
              className="absolute xl:-left-20  xl:top-28  xl:mb-20 -z-0"
            />
          </div>

          {/* Text content */}
          <div className="w-full md:w-1/2 text-left">
            <p className="text-gray-700 text-sm md:text-base mb-4 xl:ml-18 xl:text-[28px] font-normal xl:leading-[120%]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod lobortis diam, nec bibendum ipsum tincidunt ut.
              Sed id pulvinar quam, et euismod ipsum. Nulla ut fermentum ante. Ut vitae lacus fringilla urna viverra rhoncus. Fusce
              elit felis, aliquam quis consectetur sed, fermentum a justo.
            </p>
