...
export default function Stats() {
    return (
<section className="pt-2 pb-0 px-6 relative z-30 -mt-[300px] small-phones:-mt-[170px] sm:-mt-[130px] md:-mt-[170px] lg:-mt-[175px] lg:mb-[52px] xl:-mt-[175px] rounded-xl xl:leading-[120%]">
